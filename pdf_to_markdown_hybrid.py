    ...
    for pagenum, page in enumerate(extract_pages(pdf_path)):
        ...
        for i, component in enumerate(page_elements):
            ...
            if isinstance(element, LTRect):
                ...
                if lower_side is not None and upper_side is not None and element.y0 >= lower_side and element.y1 <= upper_side:
                    pass
                elif i < len(page_elements)-1 and not isinstance(page_elements[i+1][1], LTRect):
                    table_extraction_flag = False
                    first_element = True
                    table_num += 1
        ...
        # Concatenate the page content to the result
